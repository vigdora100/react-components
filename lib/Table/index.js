...
var Table = function (_ThemedComponent) {
  ...
  Table.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        dir = _props.dir,
        _rowHeight = _props.rowHeight,
        _rowRenderer = _props.rowRenderer,
        _onRowsRendered = _props.onRowsRendered,
        useAutoSizer = _props.useAutoSizer,
        testId = _props.testId,
        otherTableProps = (0, _objectWithoutProperties3.default)(_props, ["className", "data", "density", "dir", "rowHeight", "rowRenderer", "onRowsRendered", "useAutoSizer", "testId"]);
          ...
          return _react2.default.createElement(
            ...
            (0, _extends3.default)({
              ...
              rowHeight: function rowHeight(rowProps) {
                switch (typeof _rowHeight === "undefined" ? "undefined" : (0, _typeof3.default)(_rowHeight)) {
                  case "number":
                    return _rowHeight;
                  case "function":
                    return _rowHeight(rowProps);
                  default:
