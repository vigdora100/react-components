...
var _dots100x85White = require("./assets/dots.100x85.white.gif");

var _dots100x85White2 = _interopRequireDefault(_dots100x85White);
...
var Loader = function (_ThemedComponent) {
  ...
  function Loader(props, context) {
    ...
    _this.retrieveLoader = function () {
      ...
      if (type === "dots") {
        if (color === "aluminum") {
          return _dots100x85Aluminum2.default;
        } else if (color === "white") {
          return _dots100x85White2.default;
        }

        return _dots100x85Pelorous2.default;
      }

      if (color === "aluminum") {
        return _spinner100x100Aluminum2.default;
      }

      return _spinner100x100Pelorous2.default;
    };
...
Loader.propTypes = {
  ...
  color: _propTypes2.default.oneOf(["aluminum", "pelorous", "white"]),
