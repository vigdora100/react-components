...
var Callout = function (_ThemedComponent) {
  ...
  Callout.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme[type], (_classNames = {}, _classNames[theme.rtl] = dir === "rtl", _classNames[theme.floating] = floating || this.context.floating, _classNames), className)
      },
